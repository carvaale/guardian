        ...
        <form action="" onSubmit={handleSubmit} ref={loginForm}>
            <div className="rounded-[calc(1.5rem-1px)] px-10 p-12 bg-neutral-800">
              <div className="flex flex-col items-center">
                <GuardianLogo />
                <h1 className="text-xl text-center font-semibold text-gray-300 dark:text-white">Signin to your account</h1>
                <p className="text-sm text-center tracking-wide text-gray-400 dark:text-gray-300">Don't have an account? <a href="" onClick={()=> navigate("/register")} className="text-blue-600 transition duration-200 hover:underline dark:text-blue-400">Signup</a></p>
              </div>
