...
const Settings = () => {
  ...
  return (
    <>
      ...
      <div
        id="topo"
        className="flex flex-row justify-evenly items-center w-full h-screen pt-36 p-20 gap-x-10"
      >
        <div className="flex items-center justify-center">
          <form action="">
            <div className="rounded-3xl bg-neutral-800 p-10">
              <h1 className="text-xl text-center font-bold text-gray-400 dark:text-white">
                Account Settings
              </h1>
              <div id="bar" className="w-full bg-neutral-50 my-2" />
              <div className="mt-8 space-y-4">
                <input
                  className="w-full bg-transparent text-gray-300 rounded-md border border-gray-300 px-3 py-2 text-sm placeholder-gray-400 invalid:border-red-500 dark:placeholder-gray-300"
        ...
        <div className="flex items-center justify-center">
          <form action="">
            <div className="rounded-3xl bg-neutral-800 p-10">
              ...
              <div className="mt-8 space-y-4">
                <select
                  className="w-full bg-transparent text-gray-400 rounded-md border border-gray-300 px-3 py-2 text-sm placeholder-gray-400 invalid:border-red-500 dark:placeholder-gray-300"
                  name="models"
                >
